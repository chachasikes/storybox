          ...
          Object.keys(json[item]).map(propKey => {
            ...
            switch (propKey) {
              ...
              case "camera":
                ...
                let touchContollers = `
                <a-entity id="leftHand" super-hands oculus-touch-controls="hand:left; ${modelLoaded};" ${orientationOffsetLeft} rotation="180 180 180">${leftModel}</a-entity>
                <a-entity id="rightHand" super-hands oculus-touch-controls="hand:right; ${modelLoaded};" ${orientationOffsetRight} rotation="180 180 180">${rightModel}${debuggerPanel}</a-entity>`;
